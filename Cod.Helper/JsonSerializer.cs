...
namespace Cod
{
    ...
    {
        public static string SerializeObject(object value, JsonSerializationFormat? format = null) => format switch
        {
        ...
        public static T DeserializeObject<T>(string value, JsonSerializationFormat? format = null) => format switch
        {
