# Cod.Platform.Notification.Apple

Cod.Platform.Notification.Apple provides an Apple Push Notification (APNs) channel implementation for the Cod notification framework. It enables .NET applications to send push notifications to iOS/macOS devices using Apple¡¯s secure APNs infrastructure, supporting both alert and background notifications.

## What is this project about?

- Implements an APNs push notification channel for Cod.Platform.Notification.
...
```
dotnet add package Cod.Platform.Notification.Apple
```
...
```csharp
using Cod.Platform.Notification.Apple;
...
## How Cod.Platform.Notification.Apple is Consumed

Consumer projects use Cod.Platform.Notification.Apple to:
