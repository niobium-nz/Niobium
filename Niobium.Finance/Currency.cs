...
namespace Niobium.Finance
{
    ...
    public struct Currency : IEquatable<Currency>
    {
        ...
        public static readonly Currency CNY = Parse("CNY");
        public static readonly Currency USD = Parse("USD");
        public static readonly Currency AUD = Parse("AUD");
        public static readonly Currency NZD = Parse("NZD");
