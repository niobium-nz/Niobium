...
//        {
//            var result = await this.CreateCommand.ExecuteAsync(this.Creating, cancellationToken);
...
//        {
//            var result = await this.UpdateCommand.ExecuteAsync(this.Updating, cancellationToken);
//            if (result.Result.IsSuccess)
//            {
...
//        public virtual async Task DeleteAsync(StorageKey key, CancellationToken cancellationToken = default) => await this.DeleteCommand.ExecuteAsync(key, cancellationToken);
//    }
//}
