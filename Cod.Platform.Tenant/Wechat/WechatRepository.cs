...
namespace Cod.Platform.Tenant.Wechat
{
    public class WechatRepository : IRepository<WechatEntity>
    {
        ...
        public Task<EntityBag<WechatEntity>> GetAsync(int limit, string continuationToken = null, IList<string> fields = null, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }

        public Task<EntityBag<WechatEntity>> GetAsync(string partitionKey, int limit, string continuationToken = null, IList<string> fields = null, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
