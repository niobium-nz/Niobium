...
namespace Niobium
{
    public static class DateTimeOffsetExtensions
    {
        ...
        private static readonly long reverseUnixTimestampAnchor = LegacySettings.UseLegacyReverseTimestamp ? DateTimeOffset.Parse("2050-01-01T00:00:00Z").ToUnixTimeMilliseconds() : DateTimeOffset.Parse("2100-01-01T00:00:00Z").ToUnixTimeMilliseconds();
        ...
        {
            return offset.UtcDateTime.GetWeekOfYear();
        }
