namespace Niobium.Channel.Identity
{
    public class IdentityServiceOptions
    {
        ...
        public required string IDTokenEndpoint { get; set; } = Niobium.Identity.Constants.DefaultIDTokenEndpoint;

        public required string AccessTokenHost { get; set; }

        public required string AccessTokenEndpoint { get; set; } = Niobium.Identity.Constants.DefaultAccessTokenEndpoint;

        public required string ResourceTokenHost { get; set; }

        public required string ResourceTokenEndpoint { get; set; } = Niobium.Identity.Constants.DefaultResourceTokenEndpoint;
